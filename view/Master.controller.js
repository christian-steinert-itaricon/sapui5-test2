sap.ui.core.mvc.Controller.extend("de.itaricon.test.MasterMasterDetailApplication.view.Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "de.itaricon.test.MasterMasterDetailApplication.view.Master2",
			targetViewType: "XML"
		});
		...
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "de.itaricon.test.MasterMasterDetailApplication.view.Welcome",
			targetViewType: "XML"
		});
	},
