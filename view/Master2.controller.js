sap.ui.core.mvc.Controller.extend("de.itaricon.test.MasterMasterDetailApplication.view.Master2", {
	...
	onRoutePatternMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "de.itaricon.test.MasterMasterDetailApplication.view.Detail",
			targetViewType: "XML",
			transition: "slide"
		});
	},
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "de.itaricon.test.MasterMasterDetailApplication.view.NotFound",
			targetViewType: "XML"
		});
	},
